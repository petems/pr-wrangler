...
func TestBuildRows_WithSAMLErrors(t *testing.T) {
	...
	samlErrors := map[string]*github.SAMLAuthError{
		"org/repo2#30": {
			...
			AuthURL: "https://github.com/enterprises/datadog-inc/sso?authorization_request=ABC123",
		},
	}
	...
	if samlRow.SAMLError != nil && samlRow.SAMLError.AuthURL != "https://github.com/enterprises/datadog-inc/sso?authorization_request=ABC123" {
